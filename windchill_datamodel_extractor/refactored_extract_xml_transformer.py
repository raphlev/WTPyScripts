...
from custom_xml_transformations import CustomXMLTransformations
import logging
...
class XMLTransformer:
    ...
    def transform(self):
        try:
            ...
            normalized_xml_content = CustomXMLTransformations.normalize_xml(xml_content)
            ...
            ExceptionLogger.log_exception(e, '"******************  Transform xml file failed: ******************')
...
def run():
    ...
    try:
        ...
        ExceptionLogger.log_exception(e, f"******************  An error occurred while transforming {args.input}: ******************")
